...
export type RequestListElementUpdate = Partial<Exclude<ListElement, 'id'>> & Pick<ListElement, 'id'>;
export type RequestListElementCreate = Partial<Exclude<ListElement, 'id'>> & Pick<ListElement, 'name'>;
